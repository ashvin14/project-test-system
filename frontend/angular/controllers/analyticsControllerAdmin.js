app.controller('analyticsControllerAdmin',function($scope, $routeParams, apiservice,$window) {
    $scope.data = []
    $scope.labels = []
    ...
    apiservice.getTestAndScoresForAdmin($routeParams.id,data).then(function(response) {
        var index = 1;
